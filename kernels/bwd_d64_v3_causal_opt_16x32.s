...
label_0291:
    ...
    ds_read_b128 v[232:235], v28
    ds_read_b128 v[236:239], v28 offset:512
    s_waitcnt vmcnt(16) lgkmcnt(0)
    s_barrier
    s_cmp_lt_i32 1, s72
...
label_02FF:
    ...
    ds_read_b128 v[240:243], v28
    ds_read_b128 v[244:247], v28 offset:512
    s_waitcnt vmcnt(16) lgkmcnt(0)
    s_barrier
    s_cmp_lt_i32 2, s72
...
label_036D:
    ...
    ds_read_b128 v[248:251], v28
    ds_read_b128 v[252:255], v28 offset:512
    s_waitcnt vmcnt(16) lgkmcnt(0)
    s_barrier
    s_cmp_lt_i32 0, s72
...
label_0460:
    ...
    ds_read_b128 v[80:83], v16 offset:512
    ds_read_b128 v[84:87], v16 offset:2176
    ds_read_b128 v[88:91], v16 offset:2688
...
label_1476:
    ...
    v_mul_f32_e32 v34, s48, v34
    v_mul_f32_e32 v35, s48, v35
    v_cvt_pk_bf16_f32 v58, v34, v35
    v_accvgpr_read_b32 v34, a126
    v_accvgpr_read_b32 v35, a127
    v_mul_f32_e32 v34, s48, v34
    v_mul_f32_e32 v35, s48, v35
    v_cvt_pk_bf16_f32 v59, v34, v35
    ...
    v_mul_f32_e32 v34, s48, v34
    v_mul_f32_e32 v35, s48, v35
    v_cvt_pk_bf16_f32 v66, v34, v35
    v_accvgpr_read_b32 v34, a142
    v_accvgpr_read_b32 v35, a143
    v_mul_f32_e32 v34, s48, v34
    v_mul_f32_e32 v35, s48, v35
    v_cvt_pk_bf16_f32 v67, v34, v35
